...
export default function Others({ categoryData }) {
    return (
        <>  <h4 className='text-center py-4  font-bold text-2xl'>Others</h4>
...
export const getStaticProps = async () => {
    const res = await fetch(`https://build-master-pro.vercel.app/api/categories/7`);
