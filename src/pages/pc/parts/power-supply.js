...
export default function PowerSupply({ categoryData }) {
    return (
        <>  <h4 className='text-center py-4  font-bold text-2xl'>Power Supply</h4>
...
export const getStaticProps = async () => {
    const res = await fetch(`https://build-master-pro.vercel.app/api/categories/4`);
