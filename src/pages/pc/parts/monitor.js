...
export default function Monitor({ categoryData }) {
    return (
        <>  <h4 className='text-center py-4  font-bold text-2xl'>Monitor</h4>
...
export const getStaticProps = async () => {
    const res = await fetch(`https://build-master-pro.vercel.app/api/categories/6`);
